...
This method takes a callback function with two values.
    Accumulator
    Current Value
Optionally we can pass a second argument to the ".reduce()", that is the valeu to inicialize the accumulator.
...
/*
In this example we are using reduce to sun all the values in the array.
