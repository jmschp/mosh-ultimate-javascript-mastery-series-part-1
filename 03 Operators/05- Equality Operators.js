...
/*
As we seen in the last lectures we have different equalilty operators
    ==	equal to	
...
// Ina strict equalaty operator both values have to be of the same type and mus have the same value
...
console.log(false === 1) // Heere we ge false.
