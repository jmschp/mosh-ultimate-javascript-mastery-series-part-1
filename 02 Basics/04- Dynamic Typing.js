...
We have two types of programing languages 
    Static languages (Statically-typed)
      ...
      For example "string name = 'Miguel'", this varibale is a of type string and can not be changed.
...
// This is whate we call a dynamic language, the type of this variables will be determined at runtime, base on the value er assign to them.
